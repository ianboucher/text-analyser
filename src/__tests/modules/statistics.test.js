...
describe('getWordCount', () => {
    ...
    //     const sentence2 = `${faker.lorem.words(10)}\r`.split(' ');
    //     const sentence3 = `${faker.lorem.words(10)}\n\n\n`.split(' ');
    //     const words = [...sentence1, ...sentence2, ...sentence3];

    //     expect(getWordCount(words)).toBe(30);
    // });

    // test('ignores words made entirely from numbers', () => {
    //     const words = `0 ${faker.lorem.words(10)} 1234 ${faker.lorem.words(10)} 5678`.split(' ');
...
describe('getMeanWordLength', () => {
    ...
    //     const words4 = Array(5).fill().map(() => faker.lorem.word(4));
    //     const words7 = Array(5).fill().map(() => faker.lorem.word(7));
    //     const numbers = Array(10).fill('111111111111  22222222 333333333333333');
    //     const text = [...words3, ...words4, ...words7, ...numbers];
...
describe('getMostCommonLetter', () => {
    ...
    //     expect(getMostCommonLetter(undefined)).toEqual([]);
    //     expect(getMostCommonLetter(null)).toEqual([]);
    //     expect(getMostCommonLetter([])).toEqual([]);
    //     expect(getMostCommonLetter(123)).toEqual([]);
    // });
